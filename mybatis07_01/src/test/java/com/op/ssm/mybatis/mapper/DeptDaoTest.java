...
public class DeptDaoTest {
    ...
    public void testSelectTable01() {
        ...
        // 执行方法 不仅会把数据缓存  而且会把查询结果保存在缓存里    key com.op.ssm.mybatis.mapper.DeptDao.selectTable01.2
        ...
        //sqlSession.commit();
        //执行更新语句的时候也会清空缓存
        //deptDaoImp.insertTable01(Dept.builder().name("dept04").build());

        Dept dept01 = deptDaoImp.selectTable01(2);
    ...
    public void testSelectTable02() {
        ...
        // 执行方法 不仅会把数据缓存  而且会把查询结果保存在缓存里    key com.op.ssm.mybatis.mapper.DeptDao.selectTable01.2
        Dept dept02 = deptDaoImp.selectTable01(3);
